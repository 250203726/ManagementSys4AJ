<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonalInformation.aspx.cs" Inherits="WebPages.OtherCompany.PersonalInformation" %>
    ...
    <script type="text/javascript">
        $(function () {
           ...
           $("#maingrid").ligerGrid({
               ...
               //data:grid_data.data,
               url: "../NB_JsonHttp.aspx?oprtype=getfiles4grid&strkey="+myEscape('岗位人员信息'),
               pageSize: 30,
               rownumbers: true,
               toolbar: {
                   items:<%= buttonJson %>
