<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ToolsEvaluate.aspx.cs" Inherits="WebPages.OtherCompany.ToolsEvaluate" %>
    ...
    <script type="text/javascript">
        $(function () {
           ...
           $("#maingrid").ligerGrid({
               ...
               //data:grid_data.data,
               url: "../NB_JsonHttp.aspx?oprtype=getfiles4grid&strkey="+myEscape('工器具管理评价'),
               pageSize: 30,
               rownumbers: true,
               toolbar: {
                   items:<%= buttonJson %>
