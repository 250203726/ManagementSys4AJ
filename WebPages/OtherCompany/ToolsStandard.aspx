<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ToolsStandard.aspx.cs" Inherits="WebPages.OtherCompany.ToolsStandard" %>
    ...
    <script type="text/javascript">
        $(function () {
           ...
           $("#maingrid").ligerGrid({
               ...
               //data:grid_data.data,
               url: "../NB_JsonHttp.aspx?oprtype=getfiles4grid&strkey="+myEscape('工器具配置标准'),
               pageSize: 30,
               rownumbers: true,
               toolbar: {
                   items:<%= buttonJson %>
