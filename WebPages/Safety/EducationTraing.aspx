<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EducationTraing.aspx.cs" Inherits="WebPages.Safety.EducationTraing" %>
    ...
    <script type="text/javascript">
        $(function () {
           ...
           $("#maingrid").ligerGrid({
               ...
               //data:grid_data.data,
               url: "../NB_JsonHttp.aspx?oprtype=GetFilesAndArticle4Grid&strkey="+myEscape('教育培训'),
               pageSize: 30,
               rownumbers: true,
               toolbar: {
                   items:<%= buttonJson %>
       ...
       function AddItem(btn) {
           window.top.f_addTab("Save_EducationTraing", btn.text + "-教育培训", "/Safety/SavePage/SaveEducationTraing.aspx?nodeid=42&mode=1&v=" + Math.random());
       }
