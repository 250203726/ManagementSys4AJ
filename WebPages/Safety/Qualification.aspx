<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qualification.aspx.cs" Inherits="WebPages.Safety.Qualification" %>
    ...
    <script type="text/javascript">
        $(function () {
           ...
           $("#maingrid").ligerGrid({
               ...
               url: "../NB_JsonHttp.aspx?oprtype=GetFilesAndArticle4Grid&strkey=" + myEscape('资质审核'),
               pageSize: 30,
               rownumbers: true,
               toolbar: {
                   items:<%= buttonJson %>
            ...
            $(document).on("click", "table.l-grid-body-table td div.l-grid-row-cell-inner a[name=article]", function (e) {
                ...
                if (top_tab.isTabItemExist("Qualification")) {
                    top_tab.setHeader("Qualification", author + "-资质审核");
                    top_tab.setTabItemSrc("Qualification", url);
                    top_tab.reload("Qualification");
                    top_tab.selectTabItem("Qualification");
                    return;
                }
                window.top.f_addTab("Qualification", author + "-资质审核", url);
            });
        ...
        function ItemClick(btn) {
            window.top.f_addTab("Save_Qualification", "新建-资质审核", "/Safety/SavePage/SaveQualification.aspx?mode=1&v=" + Math.random());
        }
        ...
        function EditItem(btn) {
            ...
            window.top.f_addTab("Save_Qualification", "新建-资质审核", "/Safety/SavePage/SaveQualification.aspx?mode=2&oid="+ rows[0].id +"&v=" + Math.random());
        }
