<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuIndex_bak.aspx.cs" Inherits="WebPages.SystemManage.MenuIndex_bak" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        input[name=enable], input[name=group_id] {
        display:none;
        }
    </style>
        ...
        $(function () {
            ...
            window['f'] = $("#myform").ligerForm({
                ...
                fields: [
                    ...
                    { display: "菜单名称", name: "name", type: "text", newline: false, group: "基础信息", groupicon: groupicon, isSort: true },
                     { display: "父级菜单", name: "parentId", type: "text", newline: false },
                       ...
                       { display: "层&nbsp;&nbsp;&nbsp;&nbsp;级", name: "levels", type: "text", newline: false },
                       { display: "显示顺序", name: "sortCode", type: "text", newline: false },
                       { display: "是否启用", name: "enable", type: "select", newline: true, comboboxName: "enable",
                       options: {
                           data: [
                                    {
                                        id:"1",
                    ...
                    {
                        display: "菜单类型 ", name: "group_id", type: "select", newline: true, comboboxName: "group_id",      options: {
                            data: [
                                {
                                    id:"1",
                                    text: "按钮"
